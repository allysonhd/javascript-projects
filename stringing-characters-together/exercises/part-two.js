...
dna = dna.trim().toUpperCase(); //I need to look at this again. I didn't do it this way and my way didn't work, but I thought it did.
console.log(dna);
...
//dnaTwo = "TCG-TAC-GAC-TAC-CGT-CAG-ACT-TAA-CCA-GTC-CAT-AGA-AGG";
//console.log(dnaTwo);
...
console.log(dna.slice(12,19).replace("-", "o").replace("G", "a").toLowerCase());

// Try again using the template literal
console.log(`${dna.slice(4,7).toLowerCase()}o${dna.slice(40,43).toLowerCase()}`);

//Why did they do "index of cat" instead?